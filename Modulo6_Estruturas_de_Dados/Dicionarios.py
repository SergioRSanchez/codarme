...
alice = {"nome": "Alice", "idade": 27, "admin": False}
bob = {"idade": 30, "admin": True, "nome": "Bob"}
print(alice["nome"])
print(bob["nome"])
...
sergio = {"nome": "Sergio", "endereço": {"rua": "25 de Março", "número": "1234"}}
print(sergio["nome"])
